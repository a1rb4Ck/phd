...
Les contraintes qui s'appliquent à la réalisation de la mesure du produit, au sein de la ligne de production, sont synthétisées dans le Tableau \ref{tab:industrial_constaints}.
...
La mesure directe est l'objet du paragraphe suivant.
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[r]{0.20\textwidth}
		$\ = 1,326$
	\end{subfigure}
	\caption{Filtrage de la photographie d'une pièce par un mode de la base $B$.}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{../Chap2/Figures/DMD_reconstruction_27modes.png}
...
% Validation croisée
% Deep Learning
L% a sélection automatique des descripteurs est réalisée par la méthode des Forêts d'arbres décisionnels.

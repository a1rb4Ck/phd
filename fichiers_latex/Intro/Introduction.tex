...
Le second chapitre a pour objectifs de présenter les différentes technologies de métrologies existantes et de discuter de notre choix d'utilisation de l'imagerie non-conventionnelle.  %  \ref{ch:measure} (i) présenter ; (ii) discuter

Le troisième chapitre a pour objectifs de présenter la méthode d'acquisition expérimentale des données de nos études et de discuter des méthodes de transfert de la connaissance de l'humain vers la machine, par l'annotation du jeu de données.  % \ref{ch:dataset} (i) présenter ; (ii) discuter

Le quatrième chapitre propose d'étudier les moyens de formalisation de la notion de Qualité par apprentissage et de les évaluer sur notre cas d'application industriel.  % \ref{ch:metric_learning} 

Le cinquième chapitre détaille la conception d'un nouveau dispositif de mesures et son évaluation sur des cas d'étude industriels.  % \ref{ch:theeye} (i) la conception ; (ii) son évaluation

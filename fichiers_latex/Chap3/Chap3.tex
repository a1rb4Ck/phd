...
\begin{figure}[hbtp]
	...
	\draw[decorate,transform canvas={xshift=-1em},thick,align=center] (data_collection.south west) -- node[left=2pt] {Mesure \\ en ligne §\ref{sec:dataset}} (data_collection.north west);
...
% \begin{raggedright}
\section{Construction du jeu de données d'apprentissage à partir de l'expertise humaine} \label{ch:dataset}
% \end{raggedright}
...
Nous avons appliqué cette méthode dans \citetitle{nagorny_polarimetric_2019} \cite{nagorny_polarimetric_2019}, sur notre problématique de l'apprentissage supervisé d'un modèle pour le contrôle de la qualité.
